...
<head>
    ...
    <script type="text/javascript">
        ...
        var TOP_MENU_DATA = [
            {
                menuCd: "00-swagger", id: "swagger", progNm: 'Swagger', name: 'Swagger', menuNm: 'Swagger', progPh: '/swagger/index.html', url: '/swagger/index.html', program: {
                progCd: "Swagger",
                progNm: "Swagger",
            ...
            {
                menuCd: "01-H2Console", id: "H2-Console", progNm: 'H2-Console', name: 'H2-Console', menuNm: 'H2-Console', progPh: '/h2-console', url: '/h2-console', program: {
                progCd: "H2-Console",
                progNm: "H2-Console",
                progPh: "/h2-console"
            }
    ...
    <script type="text/javascript" src="<c:url value='/assets/js/ppmboot/dist/ppmboot.js' />"></script>
    <script type="text/javascript" src="<c:url value='/ppmboot.config.js' />"></script>
    ...
    <div class="ax-frame-header">
        <div class="ax-split-col" style="height: 100%;">
            ...
            <div class="ax-split-panel cell-logo">
                <a href="#">
                    <img src="/assets/images/header-logo.png" width="100%"/>
                </a>
            </div>
