...
<ppm:layout name="pop">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/MT-CLN01.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    	<script type="text/javascript" src="<c:url value='/assets/js/socket-common.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
            <h1 style="margin-bottom:10px; margin-top:10px; font-size:40px"><i class="cqc-list"></i><span class ="todayDate"></span> 세척기 모니터링</h1>
