...
var ACTIONS = ppmboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
        ppmboot.ajax({
            type: "GET",
            url: ["basic", "master"],
            data: $.extend({userCd:SCRIPT_SESSION.userCd}, getSerializeArrayToJson("#searchView0")),
...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "mainCd", label: "대분류코드", width: 150, align: "center"},
                {key: "mainNm", label: "대분류명", width: 200, align: "left"},
                {key: "pgModuleCd"},
                {key: "cdType"},
                {key: "useYn"}
            ],
