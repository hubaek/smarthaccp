...
<ppm:layout name="base"> 
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/SYS000.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
        ...
        <ppm:split-layout name="ax1" orientation="vertical">
            ...
            <ppm:split-panel width="*" style="padding-left: 10px;" scroll="scroll">
                ...
                <ppm:form name="formView01">
                	<ppm:tbl clazz="ax-form-tbl" minWidth="500px">  
                        <ppm:tr>
                            <ppm:td label="대분류코드" width="50%">
                                <input type="text" data-ax-path=mainCd title="대분류코드" class="form-control" data-ax-validate="required"/>
                            </ppm:td>
                            <ppm:td label="대분류명" width="50%">
                                <input type="text" data-ax-path="mainNm" title="대분류명" class="form-control" data-ax-validate="required"/>
                            </ppm:td>        
                        </ppm:tr>        
                        <ppm:tr> 
                        	<ppm:td label="사용모듈코드" width="50%">
	                        	<ppm:common-code mainCd="PG_MODULE_CD" emptyValue="" dataPath="pgModuleCd"/>
                            </ppm:td>
                            <ppm:td label="공통코드유형" width="50%">
	                        	<ppm:common-code mainCd="CD_TYPE" emptyValue="" dataPath="cdType" />
                            </ppm:td>
                        </ppm:tr>        
                        <ppm:tr>  
	                      	<ppm:td label="담당자" width="50%">
			                	<div class="form-inline">
				                    <div class="form-group">
				                        <input type="text" data-ax-path="userCd" class="form-control W80" readonly="readonly"  placeholder="사용자ID" class="form-control"/>
				                        <input type="text" data-ax-path="userNm" class="form-control W80" readonly="readonly" placeholder="사용자명"/>
				                    	<button type="button" class="btn btn-primary W30" data-form-view-01-btn="user_modal">
                    ...
                    <div id="gridView02" data-ax5grid="grid-view-02" style="height: 560px;"></div>
                </ppm:form>
            </ppm:split-panel>
        </ppm:split-layout>
    </jsp:body>
