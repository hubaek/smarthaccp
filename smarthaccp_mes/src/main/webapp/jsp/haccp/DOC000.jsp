...
<ppm:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/DOC000.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
            ...
            <ppm:form name="searchView0">
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px" id="searchTb">
                    <ppm:tr>
                       ...
                       <ppm:td label="등록일자" width="300px">
                     		<ppm:period-picker fromId="fromDate" toId="toDate" dateType="MON"/>
                        </ppm:td>
                        <ppm:td label='통합검색' width="400px">
                            <ppm:input type="text" name="data1" clazz="form-control" placeholder="문서명, 등록자"/>
                        </ppm:td>  
                    </ppm:tr>
                </ppm:tbl>
            </ppm:form>
