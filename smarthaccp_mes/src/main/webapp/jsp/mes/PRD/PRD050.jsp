...
<ppm:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/PRD050.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
                    ...
                    <ppm:tr>
                        <ppm:td label='회사' width="230px">
                         ...
                         <ppm:td label='계획일자' width="230px">
                         	<ppm:period-picker fromId="planDt" dateType="TODAY" />
                        </ppm:td> 
        ...
        <ppm:split-layout name="ax1" orientation="horizontal">
            <ppm:split-panel width="*" style="">
                <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                    <div class="left">
                        <h5><i class="cqc-list"></i>품목별 일생산계획</h5>
                    </div>
                </div>                
