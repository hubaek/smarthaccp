...
<ppm:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/PRD111.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
            ...
            <ppm:form name="searchView0">       
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px" id="searchTb">
                    ...
                    <ppm:tr>     
                        ...
                        <ppm:td label="지시상태" width="230px">
                     		<ppm:common-code mainCd="ORDER_ST" dataPath="orderSt" name="orderSt" emptyText="전체" emptyValue=""/>
                        </ppm:td>
                    </ppm:tr>
                </ppm:tbl>
            </ppm:form>
