...
var ACTIONS = ppmboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
    	caller.gridView01.target.exportExcel("생산불량현황.xls");
    },
...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "startDt", label: "작업일자",width: 120, align: "center"},
                {key: "orderNo",width: 120},
                {key: "routCd",width: 120}, 
                {key: "equipCd"},
                {key: "itemCd"},
                {key: "itemNm",width: 280}, 
                {key: "badDtm", label: "발생시간",width: 160, align: "center", formatter:function(){
            ...
            footSum: [
                [  
                    ...
                    {key: "badItemQty", collector: "sum", formatter:"number", align: "right"}
                ]],
            body: {
            }
        });
