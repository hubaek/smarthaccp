...
<ppm:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/PRD118.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
            ...
            <ppm:form name="searchView0">       
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px" id="searchTb">
                    ...
                    <ppm:tr> 
                        ...
                        <ppm:td label='비가동명' width="230px">
                        	<input type="text" name="nwrkNm" class="form-control" value=""/>
                        </ppm:td> 
                    </ppm:tr>
                </ppm:tbl>
            </ppm:form>
        ...
        <ppm:split-layout name="ax1" orientation="horizontal">        	
           <div class="ax-button-group" data-fit-height-aside="grid-view-01">
	           <div class="left">
	              <h5><i class="cqc-list"></i>작업지시별 비가동 목록</h5>
	           </div>
           </div>
