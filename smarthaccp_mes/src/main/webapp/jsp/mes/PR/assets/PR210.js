        ...
        if (typeof list[0] === "undefined"){
        	...
        	customModal.open({
	            ...
	            iframe: {
	                ...
	                param: "callBack=customCustSelelctModalCallback&exceptCustType=10&itemCd="+list[0].itemCd+"&itemNm="+list[0].itemNm
	            }
	        });    			
        }
    },    
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [  
                ...
                {key: "unitPrice", label:"판매단가", editor: {type: "number"},styleClass: "grid-cell-blue"},
