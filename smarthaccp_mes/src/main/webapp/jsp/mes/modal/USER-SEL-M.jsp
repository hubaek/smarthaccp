...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/USER-SEL-M.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
            ...
            <ppm:form name="searchView0">
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ppm:tr>
                        ...
                        <ppm:td label='ID' width="270px" >
                            <input type="text" id="userCd" name="userCd" class="form-control"/>
                        </ppm:td>
                        <ppm:td label='이름' width="270px" >
                            <input type="text"  name="userNm" class="form-control"/>
                        </ppm:td>
                    </ppm:tr>
                    <ppm:tr>
                        <ppm:td label='부서' width="250px" >
			                <ppm:common-code mainCd="DEPT_CD" dataPath="deptCd" name="deptCd" emptyText="전체"/>
                        </ppm:td>
                    </ppm:tr>
                </ppm:tbl>
            </ppm:form>
        ...
        <ppm:split-layout name="ax1" orientation="vertical">
            <ppm:split-panel width="100%" style="padding-right: 10px;">
                ...
                <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                    <div class="left">
                        <h2><i class="cqc-list"></i>사용자정보</h2>
                    </div>
                </div>
