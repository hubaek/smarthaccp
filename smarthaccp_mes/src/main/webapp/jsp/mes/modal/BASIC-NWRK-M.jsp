...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/BASIC-NWRK-M.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
            ...
            <ppm:form name="searchView0">
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ppm:tr>
                        ...
                        <ppm:td label='비가동코드' width="270px" >
                            <input type="text" id="subCd" name="subCd" class="form-control"/>
                        </ppm:td>
                        <ppm:td label='비가동명' width="270px" >
        ...
        <ppm:split-layout name="ax1" orientation="vertical">
            <ppm:split-panel width="100%" style="padding-right: 10px;">
                ...
                <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                    <div class="left">
                        <h2><i class="cqc-list"></i>비가동유형</h2>
                    </div>
                </div>
