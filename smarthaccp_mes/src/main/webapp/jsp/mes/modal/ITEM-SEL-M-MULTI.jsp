...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/ITEM-SEL-M-MULTI.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    ...
    <jsp:body>
        <ppm:page-buttons help="N">
            ...
            <button type="button" class="btn btn-info W50" data-page-btn="choice"><ppm:lang id="ax.admin.sample.modal.button.choice"/></button>
                ...
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px" id="searchTb">
                    <ppm:tr>
                        ...
                        <ppm:td label='품목유형' width="250px">
	                        <ppm:common-code mainCd="ITEM_TYPE" emptyText="전체" dataPath="itemType" id="itemType" name="itemType"/>
                        </ppm:td>
