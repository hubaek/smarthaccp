...
<ppm:layout name="base"> 
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/STD010.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
        ...
        <ppm:split-layout name="ax1" orientation="vertical">
            ...
            <ppm:split-panel width="*" style="padding-left: 10px;" scroll="scroll">
                ...
                <ppm:form name="formView01">
                    ...
                    <div data-ax5grid="grid-view-02" style="height: 470px;"></div>
                </ppm:form>
            </ppm:split-panel>
        </ppm:split-layout>
    </jsp:body>
