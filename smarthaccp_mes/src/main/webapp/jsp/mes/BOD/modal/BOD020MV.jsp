...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/BOD020MV.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title"><i class="cqc-browser"></i> 시스템업데이트</h1>  
    </jsp:attribute>
    <jsp:body>    	
				...
				<ppm:tr>          
	       		...
	       		<ppm:tr>     
					<ppm:td label='내용' width="100%">
      					<textarea data-ax-path="boardText" class="form-control" rows=22  readonly="readonly"></textarea>
					</ppm:td>
		       </ppm:tr>
	           	<ppm:tr>  
