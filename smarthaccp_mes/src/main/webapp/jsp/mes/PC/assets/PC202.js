...
var ACTIONS = ppmboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {    	    	
    	ppmboot
	   	 .call({
	            ...
	            data: $.extend({inoutType:"OUT_USE",whType:"10"}, getSerializeArrayToJson("#searchView0")),
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
    	caller.gridView01.target.exportExcel("원재료 출고현황.xls");
    },
...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "inoutTypeDetail", width: 160},
                {key: "inoutDt", width: 160,label: "출고일"},
                {key: "inoutSeq", width: 60},  
                {key: "itemCd", width: 140},
                {key: "itemNm", width: 200},    
                //{key: "partNo"},
                {key: "itemQty", label: "출고수량", width: 110, formatter:"number", align: "right"},
                {key: "unit", width: 110},
                {key: "whCd", width: 110},
                {key: "lotNo", width: 110},
