...
var ACTIONS = ppmboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
    	caller.gridView01.target.exportExcel("원재료 수불원장.xls");
    },
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
            	...
            	{key: "slipCd", width: 100, label: "마감번호", formatter:function(){
                ...
                //{key: "partNo"},
                {key: "spec"},
                {key: "pcDt", label: "매입일자", width: 80, align: "center"},
                {key: "surtaxYn"},
                {key: "itemQty"},
                {key: "unitAmt"},
                {key: "supplyAmt"},
