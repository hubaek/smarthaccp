        ...
        <c:otherwise>
            <div class="app-content app-wrap">
                ...
                <article class="content">
                    <h3 data-menu-item="Controller">Controller</h5>
                    <pre class="prettyprint linenums">${jpaMvcModel.getController().code()}</pre>
                </article>

                <article class="content">
                    <h3 data-menu-item="Modal">Entity</h5>
