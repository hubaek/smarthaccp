...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/REPORT021M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title"><i class="cqc-browser"></i> 협력업체 점검표<span id = "pgmTitle"></span></h1>  
    </jsp:attribute>
    <jsp:body>    	
		...
		<div id="modal-content" style="height:690px;">
			<ppm:form name="formView01">
                <ppm:tbl clazz="ax-form-tbl" minWidth="500px">  
                        ...
                        <ppm:tr>
                            <ppm:td label="협력업체명" width="33%">
                                <input type="text" data-ax-path="mitem001" title="협력업체명" class="form-control"/>
                            </ppm:td>
                        </ppm:tr>
