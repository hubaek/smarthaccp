...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
				{key: "ditem001", label: "구분", align: "center", width: 200},
				{key: "ditem002", label: "항목", align: "center", width: 200},
				{key: "ditem003", label: "기준", align: "center", editor: {type: "text"}},
				{key: "ditem004", label: "배점", align: "center", editor: {type: "text"}},
				{key: "ditem005", label: "결과", align: "center", editor: {type: "text"}},
				{key: "ditem006", label: "비고", align: "center", editor: {type: "text"}}
            ],
            body: { 
                onClick: function () {
