...
fnObj.gridView02 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "ditem001", label: "교육대상 및 내용", editor: {type: "text"}, width: 300,align: "left"},
                {key: "ditem002", label: "훈련년도",  editor: {type: "text"}, width: 300, align: "center"},
                {key: "ditem014", label: "비고", editor: {type: "textarea"}, width: 300, align: "center"},
            ],
            body: { 
                onClick: function () {
