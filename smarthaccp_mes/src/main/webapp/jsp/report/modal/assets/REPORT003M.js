...
//        });
	...
	PRINT_POPUP: function(caller, act,data){
    	if(caller.formView01.getData() != undefined){
    		...
    		window.open("../print/REPORT003_P.jsp?reportDate="+reportDate);
    	}else{
    		axDialog.alert({
    			theme: "primary",
...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "ditem001", label: "구분", width: 150,align: "center"},
                {key: "ditem002", label: "구분", width: 100,align: "center"},
                {key: "ditem003", label: "점검항목", width: 500, align: "left",multiLine:true,formatter:function formatter() {
                    return this.value.replace(/\r\n/gi,"<br/>");
            	}
                },
                {label: "점 검 일 자  및  결 과" , columns:[
            		{key: "ditem004", label: "1주",width: 70, sortable: false, align: "center", editor: {type: "text", config: {height: 17, trueValue: "Y", falseValue: "N"}}},
                    {key: "ditem005", label: "2주",width: 70, sortable: false, align: "center", editor: {type: "text", config: {height: 17, trueValue: "N", falseValue: "Y"}}},
            		{key: "ditem006", label: "3주",width: 70, sortable: false, align: "center", editor: {type: "text", config: {height: 17, trueValue: "N", falseValue: "Y"}}},
            		{key: "ditem007", label: "4주",width: 70, sortable: false, align: "center", editor: {type: "text", config: {height: 17, trueValue: "N", falseValue: "Y"}}},
            		{key: "ditem008", label: "5주",width: 70, sortable: false, align: "center", editor: {type: "text", config: {height: 17, trueValue: "N", falseValue: "Y"}}}
	            	]
            	}
            ],
            body: { 
