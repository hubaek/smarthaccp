...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/REPORT005M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title"><i class="cqc-browser"></i> 검증 개선조치 결과보고서 등록<span id = "pgmTitle"></span></h1>  
    </jsp:attribute>
    <jsp:body>    	
                ...
                <ppm:tbl clazz="ax-form-tbl" minWidth="500px">  
                        ...
                        <ppm:tr>
                            ...
                            <ppm:td label="제정일자" width="25%">
                     			<ppm:date-picker dataPath="mitem002" title="제정일자"/>
                            </ppm:td>
                        ...
                        <ppm:tr>
	                        <ppm:td label="개선완료일" width="33%">
                     			<ppm:date-picker dataPath="mitem010" title="개선완료일"/>
	                        </ppm:td>	   	   
                        </ppm:tr>
                        <ppm:tr>
                        ...
                        <ppm:tr>
		                 <ppm:td label="파일첨부" width="100%">
						 	<ppm:file-uploader2 targetType = "REPORT005M" targetId = "reportDate"/>
		                 </ppm:td>
	            		</ppm:tr> 
                    </ppm:tbl>
