...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/REPORT010M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title"><i class="cqc-browser"></i>업무 인수인계서 등록 <span id = "pgmTitle"></span></h1>  
    </jsp:attribute>
    <jsp:body>    	
		...
		<div id="modal-content" style="height:690px;">
			<ppm:form name="formView01">
                <ppm:tbl clazz="ax-form-tbl" minWidth="500px">  
                        ...
                        <ppm:tr>
                        	<ppm:td label="인수자" width="50%">
                                <input type="text" data-ax-path="mitem002" title="인수자" class="form-control" />
                            </ppm:td>
                            <ppm:td label="인계자" width="50%">
                                <input type="text" data-ax-path="mitem004" title="인계자" class="form-control" />
                            </ppm:td>
                        </ppm:tr>
                        <ppm:tr>
                        	<ppm:td label="인수인계내용" width="100%">
                                <textarea data-ax-path="mitem003" class="form-control" rows=10 ></textarea>
                            </ppm:td>
                        </ppm:tr>
                       
                        <ppm:tr>
		                	<ppm:td label="파일첨부" width="100%">
						 		<ppm:file-uploader2 targetType = "REPORT010M" targetId = "reportDate"/>
		                	</ppm:td>
	            		</ppm:tr>
                    </ppm:tbl>
