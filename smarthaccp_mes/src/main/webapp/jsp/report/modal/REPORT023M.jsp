...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/REPORT023M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    </jsp:attribute>
                ...
                <ppm:tbl clazz="ax-form-tbl" minWidth="500px">  
                        ...
                        <ppm:tr>
		                	<ppm:td label="파일첨부" width="100%">
						 		<ppm:file-uploader2 targetType = "REPORT023M" targetId = "reportDate"/>
		                	</ppm:td>
	            		</ppm:tr>
                    </ppm:tbl>
