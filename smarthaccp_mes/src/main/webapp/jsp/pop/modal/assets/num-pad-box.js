...
var ACTIONS = ppmboot.actionExtend(fnObj, {
    ...
    DIVISION_BARCODE: function (caller, act, data) {  
    	...
    	axDialog.confirm({
            theme: "danger",
            width:500,
            msg: "<font color=red>입력하신 수량으로 박스바코드 발행 하시겠습니까?\nBOX당 수량:"+barcodeQty+"\n발행장수:"+printCnt+"</font>"
        }, function () {
        	if(this.key == "ok")
        	{        	
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "itemQty", label: "BOX당수량", width: 150, formatter:"number", align: "center",formatter:function(){
...
function setCalcResult1(v){
	...
	*/
	fnObj.gridView01.setCalcResult1({itemQty:nvl(v,0)});
}
