...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "qcNm",label: "검사항목", width: 250, align: "center"},
                {key: "measure1", label: "측정치", width: 180, formatter:"number", align: "right",formatter:function(){
    ...
    setDefault:function(data){
    	...
    	fnObj.gridView01.target.setValue(0,"qcNm", data.qcNm);
    	fnObj.gridView01.target.select(0);
    },
    setCalcResult:function(data){
    	fnObj.gridView01.target.setValue(0,"measure1", data.measure1);
    	fnObj.gridView01.target.select(0);
    },
...
function setDefault(qcNm){
	fnObj.gridView01.setDefault({qcNm:qcNm});
}

function setCalcResult(v){
	fnObj.gridView01.setCalcResult({measure1:v});
}
