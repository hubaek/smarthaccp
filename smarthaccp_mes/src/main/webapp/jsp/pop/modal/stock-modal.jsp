...
<ppm:layout name="pop">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/stock-modal.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
        <div class="H10"></div>        
		    ...
		    <div class="row clearfix" style="height:100%">
        		<div class="col-lg-6 col-md-12">
	                <div class="x_panel">
            			...
            			<div class="H10"></div>  
		                <div data-ax5grid="grid-view-01"  style="height: 620px"></div>
		            </div>
		        </div>
		    </div>
            <div class="H10"></div>  
