...
<ppm:layout name="pop_modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/num-pad-lot-out.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title">
            <i class="cqc-browser"></i>자재투입 
        </h1>
    </jsp:attribute>
    <jsp:body>
            ...
            <ppm:split-panel width="*" style="">
        		...
        		<table class="calculator" id="calc">				                    
		            <tr>
		                ...
		                <td class="calc_td_btn">
		                        <input type="button" class="calc_btn2" value="단위변경"/>
		                </td>
		            </tr>
		            <tr>
		                <td class="calc_td_btn">
		                ...
		                <td class="calc_td_btn" rowspan="2" >
		                        <input type="button" class="calc_btn" id ="bom_unit_btn" value="" onclick="javascript:sel_bom_unit();" />
		                </td>
		            </tr>
		            <tr>
		                <td class="calc_td_btn">
		            ...
		            <tr>
		                ...
		                <td class="calc_td_btn" rowspan="2" >
		                        <input type="button" class="calc_btn"  id ="unit_btn" value="" onclick="javascript:sel_unit();" />
		                </td>  
		            </tr>
		            <tr>
		                <td class="calc_td_btn">
