...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        <script type="text/javascript">
                    ...
                    switch (act) {
                        ...
                        case ACTIONS.CLOSE_ADDRESS:
                        	if (typeof param.callBack === "undefined"){
	                       		 if (parent && parent.ppmboot && parent.ppmboot.modal2) {
	                                    parent.ppmboot.modal2.callback(data);
	                       		 }
	                       	}else{
            ...
            fnObj.zipcodeView = ppmboot.viewExtend({}, {
                initView: function () {
    ...
    <jsp:body>
    	<div role="page-header">
             <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                 <div class="right">
         			<button type="button" class="btn btn-default W50" onclick="closeWindow();"><ppm:lang id="ax.admin.sample.modal.button.close"/></button>
                 </div>
             </div>
        </div>
        <!-- 우편번호 API [S] -->
