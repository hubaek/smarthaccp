	...
	try{
		if (SessionUtils.isLoggedIn()) {
			if(SessionUtils.getUserSystemType().equals("MONIT")){
	       		lastNavigatedPage = "/jsp/monit/MT100.jsp";
 ...
 <jsp:attribute name="script">
    ...
    <jsp:body>
		<ppm:flex-layout valign="middle" align="center" style="width:100%;height:100%;" >   
		 	 ...
		 	 <tr>
		 	 	<td>
					   <div class="panel" style="float: left;">
							...
							<div>
			             		<img src="${pageContext.request.contextPath}${config.background.background}"  style="width:450px;height:170px;"/>
							</div>
					   </div>
				 </td>
				 <td>
            ...
            <div class="txt-good-words" id="good_words"></div>
        </ppm:flex-layout>
    </jsp:body>
</ppm:layout>