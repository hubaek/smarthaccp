    	...
    	if(list.length!=1){
        	...
        	ppmboot.call({
   	   	        ...
   	   	        url: ["order","excelDataDownLoad"],
   	                ...
   	                caller.gridView03.target.exportExcel("WB000_"+getNowDt()+".xls");
   	   	         }
   	   	 	})        
   	       .done(function () {
   	       });
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "orderNo",label:"발주번호",width:100, align:"center"},
                {key: "surtaxYn"},
                {key: "sumItemQty"},
                {key: "sumSupplyPrice"},
                {key: "sumSurtax"},
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "remainYn",label:"수주상태", hidden:true},
            	{
                    label: "품목정보", columns: [
                        {key: "itemCd"},
                        {key: "itemNm"},
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "custTel"        , label: "전화번호1", width: 80, align: "center"},
                {key: "custAddress"    , label: "주소", width: 80, align: "center"},
