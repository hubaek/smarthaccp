...
SwaggerClient.prototype.setConsolidatedModels = function () {
  var model, modelNm, resource, resource_name, i, apis, models, results;
  this.models = {};
  apis = this.apis;
  for (resource_name in apis) {
    resource = apis[resource_name];
    for (modelNm in resource.models) {
      if (typeof this.models[modelNm] === 'undefined') {
        this.models[modelNm] = resource.models[modelNm];
        this.modelsArray.push(resource.models[modelNm]);
      }
    }
  }
...
SwaggerResource.prototype.addModels = function (models) {
  if (typeof models === 'object') {
    ...
    for (modelNm in models) {
      if (typeof this.models[modelNm] === 'undefined') {
        var swaggerModel = new SwaggerModel(modelNm, models[modelNm]);
        this.modelsArray.push(swaggerModel);
        this.models[modelNm] = swaggerModel;
        this.rawModels[modelNm] = models[modelNm];
      }
    }
    var output = [];
...
var SwaggerModel = function (modelNm, obj) {
  this.name = typeof obj.id !== 'undefined' ? obj.id : modelNm;
  this.properties = [];
  var propertyName;
