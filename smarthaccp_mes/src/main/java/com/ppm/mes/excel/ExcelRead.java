...
public class ExcelRead {
    public static List<Map<String, String>> read(ExcelReadOption excelReadOption) {
           ...
           for(int i =0; i<sheetNum; i++){
               ...
               if(row != null) 
               {
                    ...
                    */
                   numOfCells = 25;//row.getPhysicalNumberOfCells(); //한개의 행마다 몇개의 cell이 있는지 체크 
                   ...
                   // 	   break;
                       ...
                       if( !excelReadOption.getOutputColumns().contains(cellName) ) {
                           //System.out.println("@cellName:추출대상아님"+cellName);
                           continue;
                       }
                        ...
                        */
                       map.put(cellName, ExcelCellRef.getValue(cell,evaluator));
                   }
                   /*
    ...
    public static List<Map<String, String>> read(ExcelReadOption excelReadOption,int numOfCells) {
           //엑셀 파일 자체
           //엑셀파일을 읽어 들인다.
           //FileType.getWorkbook() <-- 파일의 확장자에 따라서 적절하게 가져온다.
           Workbook wb = ExcelFileType.getWorkbook(excelReadOption.getFilePath());
           ...
           for(int i =0; i<sheetNum; i++){
               ...
               if(row != null) 
               {
                    ...
                    * 가져온 Row의 Cell의 개수를 구한다. 
                    */
                   //numOfCells = 17;//row.getPhysicalNumberOfCells(); //한개의 행마다 몇개의 cell이 있는지 체크 
                   ...
                   for(int cellIndex = 0; cellIndex < numOfCells; cellIndex++) {
                        ...
                        * map객체의 Cell의 이름을 키(Key)로 데이터를 담는다.
                        */
                       cellValue = ExcelCellRef.getValue(cell,evaluator);
