...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "slipCd",label:"실사번호", width: 160},
                {key: "slipDt", width: 200},
                {key: "whCd", width: 140},
                {key: "modifyType", width: 200},
                {key: "userNm", width: 200},
                {key: "sumItemQty", width: 200},
                {key: "updatedAt", width: 240},
                {key: "updatedBy", width: 258},
            ],
            body: { 
                onClick: function () {
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
            	{
                    label: "품목정보", columns: [
                        {key: "itemCd", width: 160},
                        {key: "itemNm", width: 294},
                        //{key: "partNo"},
                        {key: "spec", width: 160},
                        {key: "unit", width: 160},
                    ]
