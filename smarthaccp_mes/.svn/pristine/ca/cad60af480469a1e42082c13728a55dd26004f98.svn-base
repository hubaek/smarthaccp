...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/PC030M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
        ...
        <div data-fit-height-aside="form-view-01">
	       ...
	       <ppm:tr>     
            ...
            <ppm:tr>
				...
				<ppm:td label="입고창고" width="25%" required="true">
					<ppm:wh-code dataPath="whCd" whType="10"/>
				</ppm:td>  
            ...
            <div class="ax-button-group">
                ...
                <div class="right" id = "grid-buttons">
                	<div class="form-inline">
                       <div class="form-group">
                       		<!-- 		
                       		<button type="button" class="btn btn-success W100" data-grid-view-01-btn="item-searchQR" id="item-searchQR" style="display: inline-block;">
					      		QR코드 인쇄
					        </button>
					        -->
							<button type="button" class="btn btn-success W120" data-grid-view-01-btn="item-all" id ="item-all" style="display: inline-block;">
		      						품목정보 적용
		                    </button>
		                    <button type="button" class="btn btn-default W80" data-grid-view-01-btn="item-remove" id="item-remove" style="display: inline-block;">
		                        <i class="cqc-minus"></i>
