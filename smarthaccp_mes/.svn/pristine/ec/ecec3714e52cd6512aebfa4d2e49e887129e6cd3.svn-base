				           		 ...
				           		 <div style="display: flex;">
					           	  ...
					           	  <div style="flex: 1;"> 
					                    ...
					                    <div class="left">
				                            <div class="form-inline">
				                                <div class="form-group">
											       <button type="button" class="btn btn-info W100 H75" style="background-color:#0080ff; " data-grid-view-01-btn="reg-order" id="reg-order"> 작업등록</button>
					           					</div>
					           				</div>
					           			</div>
					           		</div>
					           	  ...
					           	  <div style="flex: 1;"> 
					                    ...
					                    <div class="left">
				                            <div class="form-inline">
				                                <div class="form-group">
											       <button type="button" class="btn btn-info W100 H75" style="background-color:#FF8000; " data-grid-view-01-btn="pop-item-out" id="item-out"> 제품출고</button>
					           					   <!--  
					           					   <button type="button" class="btn btn-info W100 H75" style="background-color:#FF8000; " data-grid-view-01-btn="pop-in-out-item" id="inout-item"> 제품출고<br>(바코드)</button>
					           					   -->
					           					</div>
					           				</div>
					           			</div>
					           	  ...
					           	  <div style="flex: 1;"> 
					                    ...
					                    <div class="left">
				                            <div class="form-inline">
				                                <div class="form-group">
											       <button type="button" class="btn btn-info2 W110" data-grid-view-01-btn="sa-search" style="background-color:#ff8100; id="sa-search">제품창고재고현황</button>
					           					</div>
					           				</div>
					           				<div class="form-inline" style="margin-top: 4px;">
				                                <div class="form-group">
									 		       <button type="button" class="btn btn-info W110" data-grid-view-01-btn="sa-add" style="background-color:#ff8100; id="sa-add">제품창고재고실사</button>
					           					</div>
					           				</div>
					           			</div>
					           		</div>
