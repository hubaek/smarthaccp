...
<ppm:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/SA032.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
            ...
            <ppm:form name="searchView0">
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px" id="searchTb">
                    ...
                    <ppm:tr>      
                        ...
                        <ppm:td label="수주/출하" width="230px">
                     		<ppm:common-code mainCd="REMAIN_YN" emptyText="전체" emptyValue="" name="remainYn2"/>
                        </ppm:td>  
                    </ppm:tr>
                </ppm:tbl>
            </ppm:form>
        ...
        <ppm:split-layout name="ax1" orientation="horizontal">
            <ppm:split-panel width="*" style="">
                <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                    <div class="left">
                        <h5><i class="cqc-list"></i>미출하 수주 목록</h5>
                    </div>
                </div>                
