...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/PC030R.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title">구매입고 적용</h1>
    </jsp:attribute>
    <jsp:body>
        ...
        <div role="page-header">
      	...
      	<ppm:tab-layout name="tab1" data_fit_height_content="layout-view-01" style="height:100%;">
       		<ppm:tab-panel label="구매입고적용 (LIST)" scroll="scroll">   
                <div data-ax5grid="grid-view-03" style="height: 530px;"></div>
   			</ppm:tab-panel>		
       		<ppm:tab-panel label="구매입고적용 (건별)" scroll="scroll">   
