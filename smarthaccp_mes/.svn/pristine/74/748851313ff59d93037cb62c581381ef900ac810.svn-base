...
<ppm:layout name="modal">
    <jsp:attribute name="script">  
        ...
        <script type="text/javascript" src="<c:url value='assets/ST210M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    ...
    <jsp:body>
       ...
       <div data-fit-height-aside="form-view-01">
	       ...
	       <ppm:tr>     
              ...
              <ppm:tr>
					<ppm:td label="보낸창고" width="25%" required="true">
						<ppm:wh-code dataPath="refWhCd" whType="10"/>
					</ppm:td>
					<ppm:td label="받는창고" width="25%" required="true">
						<ppm:wh-code dataPath="whCd" whType="20"/>
					</ppm:td>
              </ppm:tr>     
              <ppm:tr>
           ...
           <div class="H5"></div>
	            <div class="ax-button-group">
	                <div class="left">
	                    <h5><i class="cqc-list"></i>이동 상세</h5>
	                </div>
