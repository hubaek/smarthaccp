...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/QC-DOC-MV.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
	                    ...
	                    <ppm:tbl clazz="ax-form-tbl">
	                    	...
	                    	<ppm:tr>             
	                           <ppm:td label="파일첨부" width="100%">
    								<ppm:file-uploader-view targetType = "QC_DOC_CODE" targetId = "slipCd" targetId2 = "itemCd" targetId3= "qcType" fileCount = "3" errMsg=""/>
	                           </ppm:td>
	                    	</ppm:tr>   
	                   	</ppm:tbl>    
	                </ppm:form>
