...
fnObj.gridView02 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "ditem001", label: "위치",  editor: {type: "text"}, width: 150, align: "left"},
                {key: "ditem002", label: "검사항목",  editor: {type: "text"}, width: 150, align: "left"},
                {key: "ditem003", label: "검사기준",  editor: {type: "text"}, width: 150, align: "left"},
                {key: "ditem004", label: "검사결과(세척전)",  editor: {type: "text"}, width: 150, align: "left"},
                {key: "ditem005", label: "검사결과(세척후)",  editor: {type: "text"}, width: 150, align: "left"},
                {key: "ditem006", label: "판정 결과(적합/부적합)",  editor: {type: "text"}, width: 350, align: "left"},
            ],
            body: { 
                onClick: function () {
