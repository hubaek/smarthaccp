...
var ACTIONS = ppmboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
    	caller.gridView01.target.exportExcel("출하검사등록.xls");
    },
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "itemCd"},
                {key: "itemNm"},     
                {key: "download",formatter:function(){
                	if(nvl(this.item.docId,0) != 0)
                		return "<span style='font-size:15px;color:red' class='cqc-arrow-with-circle-down'></span>";
                },label:"기준서",width:60,align:"center"},
                {key: "spec"},
                {key: "custNm"},     
                {key: "whCd"},
                {key: "lotNo"},
