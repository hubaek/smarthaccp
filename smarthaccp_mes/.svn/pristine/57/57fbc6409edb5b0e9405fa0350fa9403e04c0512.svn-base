...
@Table(name = "TB_MES_PC510")
@Comment(value = "상세항목관리")
@IdClass(PurchaseEndDetail.PurchaseEndItemDetailId.class)
@Alias("PurchaseEndItemDetail")
public class PurchaseEndDetail extends BaseJpaModel<PurchaseEndDetail.PurchaseEndItemDetailId> {
...
@Override
public PurchaseEndItemDetailId getId() {
return PurchaseEndItemDetailId.of(company, slipCd,  slipSeq);
}
...
public static class PurchaseEndItemDetailId implements Serializable {
	@NonNull
	private String company; 
	@NonNull
	private String slipCd;
