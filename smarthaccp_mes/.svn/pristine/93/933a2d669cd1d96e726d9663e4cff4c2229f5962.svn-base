...
fnObj.gridView02 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
            	{key: "ditem001", label: "위치", width: 200,align: "left", editor: {type: "textarea"}},
            	{key: "ditem002", label: "검사항목", width: 200,align: "left", editor: {type: "textarea"}},
            	{key: "ditem003", label: "검사기준", width: 200,align: "left", editor: {type: "textarea"}},
            	{key: "ditem004", label: "검사결과", width: 200,align: "left", editor: {type: "textarea"}},
            	{key: "ditem005", label: "판정결과", width: 200,align: "left", editor: {type: "textarea"}}
            ],
            body: {
            	onClick: function () {  
