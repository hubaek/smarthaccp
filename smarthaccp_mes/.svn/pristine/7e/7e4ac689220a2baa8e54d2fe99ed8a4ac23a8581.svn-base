...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/QC-BAD-M.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    ...
    <jsp:body>
        <ppm:page-buttons help="N">
            <button type="button" class="btn btn-info W50" data-page-btn="choice">불량적용</button>
        ...
        <ppm:split-layout name="ax1" orientation="vertical">
            <ppm:split-panel width="100%" style="padding-right: 10px;">
                ...
                <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                    <div class="left">
                        <h2><i class="cqc-list"></i>불량항목</h2>
                    </div>
                     <div class="right">
                         <button type="button" class="btn btn-default" data-grid-view-03-btn="item-add">
                             <i class="cqc-plus"></i>
