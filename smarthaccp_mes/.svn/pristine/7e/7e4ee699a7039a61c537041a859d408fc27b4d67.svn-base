...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/REPORT011M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title"><i class="cqc-browser"></i> 용수 검사 성적서<span id = "pgmTitle"></span></h1>  
    </jsp:attribute>
    <jsp:body>    	
		...
		<div id="modal-content" style="height:690px;">
			<ppm:form name="formView01">
                <ppm:tbl clazz="ax-form-tbl" minWidth="500px">  
                        ...
                        <ppm:tr>
                            <ppm:td label="구역명" width="66%">
                                <input type="text" data-ax-path="mitem001" title="구역명" class="form-control" />
                            </ppm:td>
                        </ppm:tr>
                        <ppm:tr>
                        ...
                        <ppm:tr>
	                        <ppm:td label="판정일자" width="100%">
                     			<ppm:date-picker dataPath="mitem004" requiredFlag="true"  title="점검일자"/>
	                        </ppm:td>	   	   
                        </ppm:tr>
                        <ppm:tr>
