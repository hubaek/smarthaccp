...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/QC-MASTER-M.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
            ...
            <ppm:form name="searchView0">
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px" id="searchTb">
                    <ppm:tr> 
                        ...
                        <ppm:td label='검사항목코드' width="250px">
                        	<input type="text" name="qcCd" class="form-control" value=""/>
                        </ppm:td>
                        <ppm:td label='검사항목명' width="250px">
