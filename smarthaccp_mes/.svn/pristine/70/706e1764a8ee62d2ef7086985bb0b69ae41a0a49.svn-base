    ...
    PAGE_ADD: function (caller, act, data) {
    	...
    	.call({
            ...
            callback: function (res) {
            	...
            	var mitem001 = res.map.recentlyTemplate.mitem001;
            	var mitem003 = res.map.recentlyTemplate.mitem003;
            	var mitem005 = res.map.recentlyTemplate.mitem005;
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "ditem003", label: "대상 온도계 값(B)", 	editor: {type: "text"}, width: 200,align: "left"},
                ...
                {key: "ditem006", label: "합격판정", 			editor: {type: "text"}, width: 200,align: "left"},
            ],
            body: { 
                onClick: function () {
