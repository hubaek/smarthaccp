...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/BASIC-BAD-M.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
            ...
            <ppm:form name="searchView0">
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ppm:tr>
                        ...
                        <ppm:td label='불량코드' width="270px" >
                            <input type="text" id="subCd" name="subCd" class="form-control"/>
                        </ppm:td>
                        <ppm:td label='불량명' width="270px" >
