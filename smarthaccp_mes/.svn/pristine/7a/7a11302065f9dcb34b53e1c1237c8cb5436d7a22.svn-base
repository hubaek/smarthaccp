...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
				{key: "ditem001", label: "대상", width: 400, align: "center"},
				{key: "ditem002", label: "공인기관 검교정 일자", width: 300, align: "center", editor: {type:"date"}},
				{key: "ditem003", label: "자체 검교정 일자", width: 300, align: "center", editor: {type:"date"}},
				{key: "ditem004", label: "차기 검교정 일자", width: 300, align: "center", editor: {type:"date"}}
            ],
            body: { 
                onClick: function () {
