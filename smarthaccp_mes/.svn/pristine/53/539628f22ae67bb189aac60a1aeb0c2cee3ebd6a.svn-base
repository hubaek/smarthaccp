...
<ppm:set key="page_desc" value="제품출고등록"/>
...
<ppm:layout name="pop-modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/POP-SA120M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
        <ppm:page-buttons>
        ...
        <ppm:split-layout name="ax1" orientation="vertical">
            <ppm:split-panel width="48%" style="padding-right: 10px;">
                <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                    <div class="left">
                        <h5><i class="cqc-list"></i>출하창고 재고 목록</h5>
                    </div>
                </div>
            ...
            <ppm:split-panel width="*" style="padding-left: 10px;padding-right: 5px;" scroll="scroll"  id="split-panel-form">
                <ppm:form name="formView01">
                    ...
                    <ppm:tbl clazz="ax-form-tbl">                    
	                    ...
	                    <ppm:tr>
	                    	<ppm:td label="출하유형" width="50%">
	                        	<div class="form-inline">
	                            	<div class="form-group">
			                     		<label class="checkbox-inline"><input type="radio" name="etcYn" data-ax-path="etcYn" value="N" checked>거래처출하</label>
			                     		<label class="checkbox-inline"><input type="radio" name="etcYn" data-ax-path="etcYn" value="Y" >예외출하</label>
		                        	</div>
		                        </div>
	                        </ppm:td>
	                        <ppm:td label="출하일" width="50%" required="true">
                				<ppm:date-picker dataPath="outDt" requiredFlag="true" title="출하일"/>
                           </ppm:td>
	                    </ppm:tr>    
                    	<ppm:tr>	                           
			                <ppm:td label='거래처' width="50%">
			                    <ppm:form-modal codeName="custCd" valueName="custNm"  modalType="CUST-MODAL" whereValue="10"/>
			                </ppm:td>  
                	...
                	<div class="ax-button-group" role="panel-header">
	                    <div class="left">
	                        <h5><i class="cqc-news"></i>제품입고 목록</h5>                        
	                    </div>
