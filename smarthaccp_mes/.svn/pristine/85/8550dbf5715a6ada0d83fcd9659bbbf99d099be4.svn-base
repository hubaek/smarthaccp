...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/BASIC-QC-GBN-M.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
        ...
        <div role="page-header">
            <ppm:form name="searchView0">
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ppm:tr>
                        <ppm:td label='회사' width="270px" >
	           				<ppm:company-code dataPath="company"/> 
                        </ppm:td>
                        <ppm:td label='검사유형' width="250px">
	                        <ppm:common-code mainCd="QC_TYPE" data1="ROUT" name="data1"/>
                        </ppm:td>    
                    </ppm:tr>
                    <ppm:tr>
                        <ppm:td label='코드' width="270px" >
                            <input type="text" id="subCd" name="subCd" class="form-control"/>
                        </ppm:td>
                        <ppm:td label='검사종류명' width="270px" >
                            <input type="text"  name="subNm" class="form-control"/>
                        </ppm:td>
                    </ppm:tr>
                </ppm:tbl>
            </ppm:form>
