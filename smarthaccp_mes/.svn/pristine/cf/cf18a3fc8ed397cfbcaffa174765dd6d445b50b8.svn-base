...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/REPORT018M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title"><i class="cqc-browser"></i> 연간 교육훈련 계획서<span id = "pgmTitle"></span></h1>  
    </jsp:attribute>
    <jsp:body>    	
			...
			<ppm:form name="formView01">
                <ppm:tbl clazz="ax-form-tbl" minWidth="500px">  
                        ...
                        <div class="ax-button-group">
                        	<div class="left">
                            	<h3><i class="cqc-list"></i>연간 교육훈련 계획서 목록</h3>
                        	</div>
	                        <div class="right">
                        ...
                        <ppm:tr>
		                	<ppm:td label="파일첨부" width="100%">
						 		<ppm:file-uploader2 targetType = "REPORT018M" targetId = "reportDate"/>
		                	</ppm:td>
	            		</ppm:tr>
                    </ppm:tbl>
