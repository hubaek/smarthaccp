...
var ACTIONS = ppmboot.actionExtend(fnObj, {
    ...
    END_ORDER: function (caller, act, data) {    	
    	...
    	if(nvl(mData[0].prodQty,0) == 0){
    		alertMsg = "등록된 실적이 없습니다. 작업을 종료 하시겠습니까?";
    	}else{
...
//  kjm
    ...
    //작업등록
    REG_ORDER_MODAL: function (caller, act, data) {
    	var mData = caller.gridView01.getData("selected");    	
        	ppmboot.modal.open({  
                modalType: "POP-REG-ORDER",
                param: "",
                sendData: function(){
                	return { 
                        "order" : mData[0]
                ...
                callback: function (data) {
                	ACTIONS.dispatch(ACTIONS.PAGE_SEARCH);
                	caller.gridView01.target.focus("HOME");
                }
            });
    },
    
    //제품출하
    POP_ITEM_OUT_MODAL: function (caller, act, data) {
    	
    	ppmboot.modal.open({  
            modalType: "POP-SA120M",
            param: "",
            sendData: function(){
                return {
                };
...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "orderDt",width:180},
            //  {key: "orderNo",width:180},
                {key: "itemCd",width:180},
                {key: "itemNm",width:359, formatter:function(){
                ...
                {key: "unit", width:130},
                {key: "orderQty", width:130},
                {key: "prodQty", width:130},
                {key: "goodQty", width:130},
                {key: "badQty", width:130},
                {key: "outYn", hidden: "true"},
                {key: "equipNm", label:"설비", width:200, align: "center"},
            ],
            body: {
                columnHeight: 55,
                onClick: function () {
        ...
        ppmboot.buttonClick(this, "data-grid-view-01-btn", {
            ...
            //2021-06-28 khj 작업등록
            "reg-order": function () {
                ACTIONS.dispatch(ACTIONS.REG_ORDER_MODAL);
            },
            //제품출하
            "pop-item-out": function () {
                ACTIONS.dispatch(ACTIONS.POP_ITEM_OUT_MODAL);
            },
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "wrkDtmString", label:"시작시간", width:3 , align:"center"},
...
fnObj.gridView05 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            scroller: {size: 35},
            columns: [
                {key: "badNm", label:"불량명", width:400, align:"left"},
                {key: "badQty", label: "불량수량", width: 400, formatter:"number", align: "right"},
                {key: "unit", width: 403},
                {key: "badDtm", label:"불량시간", width:630 , align:"center"},
            ],
            body: {
                columnHeight: 55,
                onClick: function () {
...
fnObj.gridView06 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "lotNo",width:350},
                {key: "barcode",width:350},
                {key: "itemQty",width: 350},
                {key: "unit"},
                {key: "updatedAt",label:"실적시간",width:683},
            ],
            body: {
                columnHeight: 55,
                onClick: function () {
