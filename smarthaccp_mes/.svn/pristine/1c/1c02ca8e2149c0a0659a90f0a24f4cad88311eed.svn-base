...
var ACTIONS = ppmboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
    	caller.gridView01.target.exportExcel("판매단가현황_"+getNowDate()+".xls");
    },    
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [  
                ...
                {key: "itemNm"},
                {key: "partNo"},
                {key: "saPrice", label:"판매 기준단가", formatter:"number" , align:"right"},
                //{key: "custCode", label: "거래처코드", width: 100, align: "center"},
                {key: "custNm", label: "거래처명", width: 100, align: "center"},
                {key: "regDt", label: "최종등록일", width: 100, align: "center"},
                {key: "unitPrice", label:"판매단가"},
