...
var ACTIONS = ppmboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
        ppmboot.ajax({
            type: "GET",
            url: ["basic", "master"],
            data: $.extend({cdType:"USER"}, getSerializeArrayToJson("#searchView0")),
...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "mainCd", label: "대분류코드", width: 150, align: "left"},
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "subNmEn", label: "소분류명(EN)", width: 150, align: "left", editor: "text",styleClass: "grid-cell-blue"}, 
                {key: "subNmZh1", label: "소분류명(CHS)", width: 150, align: "left", editor: "text",styleClass: "grid-cell-blue"}, 
                {key: "subNmZh2", label: "소분류명(CHT)", width: 150, align: "left", editor: "text",styleClass: "grid-cell-blue"},      
                {key: "sort", label: "정렬", editor: "number",styleClass: "grid-cell-blue"},  
                {key: "useYn", label: "사용유무", editor: "checkYn",styleClass: "grid-cell-blue"},        
                {key: "remark", label: "비고", width: 100, align: "left", editor: "text",styleClass: "grid-cell-blue"},
            ],
            body: {
                onClick: function () {
                }
