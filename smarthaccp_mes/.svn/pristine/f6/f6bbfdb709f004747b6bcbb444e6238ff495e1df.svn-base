...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/ITEM-ONE-M.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
                ...
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px" id="searchTb">
                    <ppm:tr>
                        ...
                        <ppm:td label='품목유형' width="250px">
	                        <ppm:common-code mainCd="ITEM_TYPE" emptyText="전체" dataPath="itemType" name="itemType" id = "itemType"/>
                        </ppm:td>
