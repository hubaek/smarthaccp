                        ...
                        $treeTarget,
                        {
                            ...
                            callback: {
                                onClick: function (event, treeId, treeNode, clickFlag) {
                                    ...
                                    if (treeNode.program) {
                                        ACTIONS.dispatch(ACTIONS.MENU_OPEN, $.extend({}, treeNode.program, {menuCd: treeNode.menuCd, menuNm: treeNode.menuNm}));
                                    }
                                }
                            }
                        },
...
fnObj.topMenuView = ppmboot.viewExtend({
    initView: function () {
        ...
        this.menu.onClick = function () {
            if (this.program) {
                ACTIONS.dispatch(ACTIONS.MENU_OPEN, $.extend({}, this.program, {menuCd: this.menuCd, menuNm: this.menuNm}));
            }
        };
...
fnObj.tabView = ppmboot.viewExtend({
    ...
    limitCount: 10,
    list: [
        {menuCd: "00-swagger", id: "swagger", progNm: 'Swagger', menuNm: 'Swagger', progPh: '/swagger/index.html', url: '/swagger/index.html', status: "on", fixed: true},
        {menuCd: "01-H2Console", id: "H2-Console", progNm: 'H2-Console', name: 'H2-Console', menuNm: 'H2-Console', progPh: '/h2-console', url: '/h2-console'},
        {menuCd: "02-ModelExtractor", id: "ModelExtractor", progNm: 'ModelExtractor', name: 'ModelExtractor', menuNm: 'ModelExtractor', progPh: '/modelExtractor/db', url: '/modelExtractor/db'}
    ],
    initView: function () {
 ...
 * activityTimerView
 */
fnObj.activityTimerView = ppmboot.viewExtend({
    initView: function () {
