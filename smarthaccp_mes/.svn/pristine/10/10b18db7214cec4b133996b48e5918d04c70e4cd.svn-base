    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "itemRemark", label: "비고", width: 254, align: "left", editor: "text",styleClass: "grid-cell-blue"},  
            ],
            footSum: [
                [  
        ...
        ppmboot.buttonClick(this, "data-grid-view-02-btn", {
            ...
            "pn-all": function () {
            	ACTIONS.dispatch(ACTIONS.PN_SELECT_MODAL_OPEN);
            },
        	"ref-item-call1": function () {
        		ACTIONS.dispatch(ACTIONS.SA020R_MODAL);
            }  
        });
    },
...
fnObj.formView01 = ppmboot.viewExtend(ppmboot.formView, {
    ...
    getDefaultData: function () {		
    	var today = getNowDt();
        return $.extend({}, ppmboot.formView.defaultData, {slipDt:today,saOrderDt:today,surtaxYn:"Y"});
    },
    initView: function () {
    ...
    setDefaultCust:function(data){
        ...
        //this.model.set("saDeliveryDt", data.saDeliveryDt); 거래처 팝업 선택시 납기일자가 null로 세팅 오류 : 김회재 수정(20.11.09)
