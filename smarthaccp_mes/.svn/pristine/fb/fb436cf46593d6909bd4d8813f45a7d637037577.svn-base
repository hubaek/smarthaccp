...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/BOD030M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
    </jsp:attribute>
				...
				<ppm:tr>          
	       		...
	       		<ppm:tr>     
					<ppm:td label='내용' width="100%">
      					<textarea data-ax-path="remark" class="form-control" rows=22></textarea>
					</ppm:td>
		       </ppm:tr>
	           	<ppm:tr>  
