    ...
    ITEM_CLICK: function (caller, act, data) {
    	...
    	ppmboot
	   	 .call({
	   	     	type: "GET",
	   	         url: ["stock","stockGroupByAll"],
	   	         data:{groupByType:"lot",itemCd:data.itemCd,zeroStock:sData.zeroStock,fromDate:sData.fromDate,toDate:sData.toDate},
	   	         callback: function (res) {	   	        	 
	   	 ...
	   	 .call({
	   	     	type: "GET",
	   	         url: ["stock","stockGroupByAll"],
	   	         data:{groupByType:"barcode",itemCd:data.itemCd,zeroStock:sData.zeroStock,fromDate:sData.fromDate,toDate:sData.toDate},
	   	         callback: function (res) {	   	        	 
	   	 ...
	   	 .call({
	            ...
	            data: {itemCd:data.itemCd,fromDate:sData.fromDate,toDate:sData.toDate},
	   	        callback: function (res) {			        	 
    ...
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {
                    label: "수량", columns: [
                        {key: "inQty", label: "입고수량(+)", width: 100, formatter:"number", align: "right"},
                        {key: "outQty", label: "출고수량(-)", width: 100, formatter:"number", align: "right"},
                        {key: "modQty", label: "조정수량", width: 100, formatter:"number", align: "right"},
                        {key: "stockQty", label: "현재고", width: 100, formatter:"number", align: "right"},
                        //{key: "maxStockQty", label: "마스터재고", width: 80, formatter:"number", align: "right"},
                    ]
                },
                {key: "unit"},  
                {key: "itemQcWay"},    
            ...
            footSum: [
                [  
                    ...
                    //{key: "maxStockQty", collector: "sum", formatter:"number", align: "right"},
