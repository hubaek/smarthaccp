...
fnObj.gridView02 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "ditem001", label: "측정값", 	editor: {type: "textarea"}, width: 400,align: "left"},
                {key: "ditem002", label: "보정율", 	editor: {type: "text"}, width: 200,align: "left"},
                {key: "ditem003", label: "합격 판정", 	editor: {type: "text"}, width: 200,align: "left"},
            ],
            body: { 
                onClick: function () {
