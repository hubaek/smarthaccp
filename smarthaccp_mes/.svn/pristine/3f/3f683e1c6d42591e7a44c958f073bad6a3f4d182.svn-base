...
var ACTIONS = ppmboot.actionExtend(fnObj, {	
    ...
    PAGE_SEARCH: function (caller, act, data) {
    	...
    	.call({
            type: "GET",
            url: ["snsr"],
            data: {company:param.company, snsrId:param.snsrId,prcssId:param.prcssId},
...
fnObj.formView01 = ppmboot.viewExtend(ppmboot.formView, {
    ...
    setData: function (data) {
        ...
        if(nvl(data.snsrId,'') != ''){
        	$("#snsrId").attr("readonly","readonly");
        }else{
        	$("#snsrId").removeAttr("readonly");        	
        }
        
        searchFile(nvl(data.snsrId,tempFileCd));
