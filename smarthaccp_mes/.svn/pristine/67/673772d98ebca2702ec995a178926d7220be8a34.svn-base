...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/PC040M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
           ...
           <div class="H5"></div>
            <div class="ax-button-group">
                ...
                <div class="right" id = "grid-buttons">
                    <!-- <button type="button" class="btn btn-success W120" data-grid-view-02-btn="stock-all" id ="stock-all">
                        	구매입고 적용
                    </button> -->
