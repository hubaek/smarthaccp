...
//                (byte)0x08, (byte)0x09, (byte)0x0A, (byte)0x0B, (byte)0x0C, (byte)0x0D, (byte)0x0E, (byte)0x0F};
    ...
    private static String ENC_KEY = "_EGM_HACCP_AUTH_";
    private static String CBC_KEY = "_EGM_HACCP_CBCK_";
    ...
    public static String encrypt(String str) {
        ...
        try {
            //암호화 함수 호출
            enc = KISA_SEED_CBC.SEED_CBC_Encrypt(ENC_KEY.getBytes(), CBC_KEY.getBytes(), str.getBytes(), 0, str.length());
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        rtn = new String(encArray, StandardCharsets.UTF_8);
    ...
    public static String decrypt(String str) {
        ...
        try {
            //복호화 함수 호출
            dec = KISA_SEED_CBC.SEED_CBC_Decrypt(ENC_KEY.getBytes(), CBC_KEY.getBytes(), enc, 0, enc.length);
            rtn = new String(dec, StandardCharsets.UTF_8);
        } catch (Exception e) {
            e.printStackTrace();
        }
