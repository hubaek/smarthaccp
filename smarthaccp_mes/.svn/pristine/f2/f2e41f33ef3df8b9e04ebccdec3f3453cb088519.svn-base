...
<ppm:layout name="modal">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/PC-LOT-M.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        <h1 class="title">
            <i class="cqc-browser"></i> 구매입고적용
        </h1>
    </jsp:attribute>
    <jsp:body>
        <ppm:page-buttons help="N">
            ...
            <button type="button" class="btn btn-info W70" data-page-btn="choice">구매입고적용</button>
        ...
        <div role="page-header">
            <ppm:form name="searchView0">
             	<input type="hidden" name="lastFlag" value="Y"/>
                <ppm:tbl clazz="ax-search-tbl" minWidth="700px" id="searchTb">
                    <ppm:tr>
                        ...
                        <ppm:td label='구매번호' width="250px" >
                            <input type="text" name="slipCd" class="form-control"/>
                        </ppm:td> 
                    </ppm:tr>
                   	<ppm:tr>
                        <ppm:td label='품목' width="300px">
							<div class="form-inline">
							    <div class="form-group">
							        <input type="text"  name="itemCd" class="form-control W79" value=""placeholder="CODE"/>
							        <input type="text"  name="itemNm" class="form-control W90" value=""placeholder="NAME"/>
							    </div>
							</div>  
                        </ppm:td>
                   	</ppm:tr>
