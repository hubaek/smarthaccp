...
<ppm:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/BOD040.js'><c:param name="v" value="${now}"></c:param></c:url>"></script>
    </jsp:attribute>
    <jsp:body>
        ...
        <div role="page-header">
            <ppm:form name="searchView0">
                <ppm:tbl clazz="ax-search-tbl" minWidth="500px" id="searchTb">
                    <ppm:tr>
                        <ppm:td label='제품' width="400px">
                        	<ppm:search-modal codeName="itemCd" valueName="itemNm"  modalType="ITEM-MODAL" whereValue="P"/>
                        </ppm:td>
                        <ppm:td label='자료명' width="400px">
                        	<input type="text" id="dataNm" name="dataNm" class="form-control" value=""/>
                        </ppm:td>
                        <ppm:td label='제조사' width="300px">
	                        <input type="text" id="madeBy" name="madeBy" class="form-control" value=""/>
                        </ppm:td>
                    </ppm:tr>
                </ppm:tbl>
            </ppm:form>
