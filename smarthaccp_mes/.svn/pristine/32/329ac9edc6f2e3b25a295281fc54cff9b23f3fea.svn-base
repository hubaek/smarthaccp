...
@Table(name = "TB_CCP_HGPRC000")
@Comment(value = "점검일자")
@IdClass(SelfHygineMaster.SelfHygineMasterId.class)
@Alias("HgPrcMaster") 
public class HgPrcMaster extends BaseJpaModel<HgPrcMaster.HgPrcMasterId> {
	...
	@Override
	public HgPrcMasterId getId(){
		return HgPrcMasterId.of(company,inspectionDate,mainCode);
	}
	@Embeddable
	@Data
	@NoArgsConstructor
	@RequiredArgsConstructor(staticName = "of")
	public static class HgPrcMasterId implements Serializable {
		/**
		 * 
		 */
