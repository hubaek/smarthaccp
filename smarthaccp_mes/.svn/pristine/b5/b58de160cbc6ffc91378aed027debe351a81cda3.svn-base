...
<ppm:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='assets/PC020M.js'><c:param name="v" value="${v}"></c:param></c:url>"></script>
       	...
       	<ppm:tbl clazz="ax-form-tbl">
        	<ppm:tr>     
           	...
           	<ppm:tr>
				...
				<ppm:td label="납기요청" width="25%">
					<ppm:date-picker dataPath="requestDt"/>
				</ppm:td>  
				<ppm:td label="입고예정" width="25%">
					<ppm:date-picker dataPath="dueDt"/>
				</ppm:td>  
