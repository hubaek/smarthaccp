...
fnObj.pageStart = function () {
    ...
    item.etc1 = param.obj.transStockQty;
    item.etc2 = nvl(param.pData.totalQty);
    item.bomUnit = param.obj.bomUnit;
	
    _this.gridView01.setDefault(item);
    _this.gridView01.target.select(0);
};
...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "etc1",label: "출고가능수량", width: 120, formatter:"number", align: "right"},
                {key: "etc2",label: "오더총소요량", width: 120, formatter:"number", align: "right"},
                {key: "bomUnit"},
    ...
    setDefault:function(data){
    	...
    	fnObj.gridView01.target.setValue(0,"etc2", data.etc2);
