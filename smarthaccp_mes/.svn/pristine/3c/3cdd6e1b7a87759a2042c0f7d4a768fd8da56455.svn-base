...
var ACTIONS = ppmboot.actionExtend(fnObj, {
    ...
    RD_TEST : function (caller, act, data) {
...
fnObj.searchView = ppmboot.viewExtend(ppmboot.searchView, {
    initView: function () {
        ...
        ppmboot.buttonClick(this, "data-page-btn", {      
            ...
            "RD-test": function () {
              	 ACTIONS.dispatch(ACTIONS.RD_TEST);
            }
        });
    }
});
...
fnObj.gridView01 = ppmboot.viewExtend(ppmboot.gridView, {
    initView: function () {
        ...
        this.target = ppmboot.gridBuilder({
            ...
            columns: [
                {key: "slipDt", width: 100},
                {key: "slipCd", width: 120,label:"수주번호", formatter:function(){
                	return "<font><u>"+nvl(this.value,'')+"</u></font>";
                }},
                {key: "saOrderType", width: 80},
                {key: "custNm", width: 180},
                {key: "userNm"},
                {key: "saOrderDt", label: "수주일자", width: 100, align: "center"},
                {key: "saDeliveryDt", label: "납기일자", width: 100, align: "center"},
                {key: "orderNo",label:"발주번호",width:100, align:"center", hidden:true},
                {key: "surtaxYn", width: 140},
                {key: "sumItemQty", width: 140},
                {key: "sumSupplyPrice", width: 160},
                {key: "sumSurtax", width: 160},
                {key: "sumTotalPrice", width: 198},
            ],
            footSum: [
                [  
